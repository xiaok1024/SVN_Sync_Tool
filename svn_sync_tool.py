...
import re
from clipboard_core import read_clipboard_html_macos, read_clipboard_html_windows
from upgrade_list_core import *  # 保留既有 rt_* 公共 API
...
# 升级清单纯逻辑已迁移到 upgrade_list_core.py；本模块继续导出原有 rt_* 名称。
